...
import { Card, Paragraph, Title,Button as RButton } from 'react-native-paper';
                    ...
                    <Card style={{marginTop:5}}>
                        ...
                        <Card.Content>
                            <View style={{flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                                <Image source={{uri:item[0]}} style={{height:95,width:95,borderRadius:15,borderColor:'#fffaf0',borderWidth:1}}/>
                                <View style={{flexDirection:'row'}}>
                                <Title style={{marginTop:5}}>@{item[1]}</Title>
                                
                                </View>
                                <Paragraph>build for memes</Paragraph>
                                ...
                                <View style={styles.profilebox}>
                                    <View style={{marginLeft:7,flexDirection:'row'}}>
                                        <View style={{flexDirection:'column',marginRight:27,marginHorizontal:25}}>
                                            <Title style={styles.profileNumberOptions}>10</Title>
                                            <Paragraph style={styles.paragraphColor}>Posts</Paragraph>
                                        </View>
                                        <View style={{flexDirection:'column',marginRight:27,marginHorizontal:25}}>
                                            <Title style={styles.profileNumberOptions}>17k</Title>
